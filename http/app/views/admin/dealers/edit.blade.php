...
@section('body')
      <div class="content site-block">
        ...
        {{ Form::open(['route' => ['admin.dealers.delete', $dealer->id], 'method' => 'DELETE', 'id' => 'delete']) }}
        {{ Form::close() }}
        
        {{ Form::model($dealer, ['route' => ['admin.dealers.update', $dealer->id], 'method' => 'POST', 'id' => 'update_profile', 'name' => 'update_profile']) }}
					<fieldset>
						<div>
              ...
              @endforeach
					...
					<fieldset>
						<ul class="info">
							<li>Email Address: <strong>{{ $dealer->user->email }}</strong></li>
          ...
          <div class="actions">
            ...
            {{ HTML::linkRoute('admin.dealers.view', 'Cancel') }}
					</div>
				{{ Form::close() }}
			</div>
		</div>
