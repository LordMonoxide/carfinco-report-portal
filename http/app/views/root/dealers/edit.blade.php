...
@section('body')
      <div class="content site-block">
        ...
        {{ Form::open(['route' => ['root.dealers.delete', $dealer->id], 'method' => 'DELETE', 'id' => 'delete']) }}
        {{ Form::close() }}
        
        {{ Form::model($dealer, ['route' => ['root.dealers.update', $dealer->id], 'method' => 'POST', 'id' => 'update_profile', 'name' => 'update_profile']) }}
					<fieldset>
						<div>
